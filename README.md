...
- 梦境深处：深蓝星空使用与主画面同类的动态漩涡坐标扭曲，星星、流星与角色本身都会随中心漩涡场轻微弯曲和旋转，并持续闪烁、随机出现流星；18 只放大至 2.0× 的原版像素小羊在整个画面中高速移动、自由转向并持续跳跃。点击或拖动会继续召唤小羊；召唤 24 只后困意达到 80%，羊群变成圆润、粗黑轮廓的像素水饺，并保持跳跃移动；转换完成后再点击一次，困意达到 100%，进入“中文的梦，要数水饺”结局。
